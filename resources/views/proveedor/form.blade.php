<div class="form-group row">
    <label class="col-md-3 form-control-label" for="nom">Proveedor</label>
    <div class="col-md-9">
        <input type="text" name="nombre" id="nombre" class="form-control" placeholder="Ingrese nombre de proveedor"
